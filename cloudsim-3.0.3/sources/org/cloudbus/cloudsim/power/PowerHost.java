...
public class PowerHost extends HostDynamicWorkload {
	...
	/**The total deactivated component ratio*/
	private double totalDeactivatedComponentRatio = 0.0f;
	
	/** Store the disabledTagsSet */
	private Set<String> disabledTagsSet = new HashSet<String>();
	
    /**The obtained revenue*/
	private double obtainedRevenue = 0.0;
	...
	public double getTotalDeactivatedComponentRatio(){
		return totalDeactivatedComponentRatio;
	}
	
	public void setTotalDeactivatedComponentRatio(double totalDeactivatedComponentRatio){
		this.totalDeactivatedComponentRatio = totalDeactivatedComponentRatio;
	}
	...
	public void setObainedRevenue(double obtainedRevenue){
		this.obtainedRevenue = obtainedRevenue;
	}

	public double getObtainedRevenue(){
		return obtainedRevenue;
	}
}
