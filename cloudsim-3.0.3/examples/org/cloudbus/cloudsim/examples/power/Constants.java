...
public class Constants {
	...
	public final static int[] VM_MIPS	= { 2500, 2000, 1000, 500 }; //Original is { 2500, 2000, 1000, 500 }  2660, 2500, 1000, 600 
	public final static int[] VM_PES	= { 1, 1, 1, 1 };
	public final static int[] VM_RAM	= { 870,  1740, 1740, 613 }; //Original is 870,  1740, 1740, 613 
	public final static int VM_BW		= 100000; // 100 Mbit/s
	public final static int []VM_SIZE		= {2500, 2000, 1000, 500}; // 2.5 GB
	...
	public final static int[] HOST_MIPS	 = { 1860, 2660 }; //Original is {1860, 2660}
	public final static int[] HOST_PES	 = { 2, 2 };
	public final static int[] HOST_RAM	 = { 4096, 4096 };
	public final static int HOST_BW		 = 1000000; // 1 Gbit/s
	public final static int []HOST_STORAGE = {1860 * 2, 2660 *2}; // 1 GB //Original is 1000000, then 10000
