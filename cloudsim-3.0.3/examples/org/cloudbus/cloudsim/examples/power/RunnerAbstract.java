...
import org.cloudbus.cloudsim.power.PowerVmAllocationPolicyMigrationUtilizationBasedProbability;
	...
	protected VmAllocationPolicy getVmAllocationPolicy(
		...
		if (vmAllocationPolicyName.equals("iqr")) {
			...
			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(
					...
					vmSelectionPolicy,
					parameter);
		} else if (vmAllocationPolicyName.equals("ubp")) {
			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationUtilizationBasedProbability(
					hostList,
					vmSelectionPolicy,
					parameter);
